            ...
            <div class="card">
                ...
                <form method="POST" action="{{ action('CompanyController@store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="company_name" type="text" class="form-control @error('company_name') is-invalid @enderror" name="company_name" value="{{ old('name') }}" required autocomplete="company_name" autofocus>
